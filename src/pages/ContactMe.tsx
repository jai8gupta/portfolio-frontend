...
const ContactMe = (props: Props) => {
  ...
  return (
    <div className='h-screen lg:w-screen snap-y snap-center flex relative flex-col text-center md:text-left md:flex-row w-[20rem] lg:max-w-7xl justify-evenly mx-auto items-center snap-mandatory'>
        <h3 className='absolute top-40 uppercase tracking-[10px] lg:tracking-[20px] text-yellow-400 text-xl lg:text-2xl'>Contact</h3>
        <div className='flex flex-col space-y-1 pt-36'>
            <h4 className='lg:text-3xl font-semibold text-center'>I Got You Covered. <span className='decoration-yellow-500 underline'>Lets Talk</span></h4>

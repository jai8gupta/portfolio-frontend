...
const SkillCard = (props: Props) => {
  return (
    <div className='group relative flex cursor-pointer rounded-full'>
        ...
        className='rounded-full border w-10 h-10 md:w-20 md:h-20 lg:object-fill lg:w-32 lg:h-5 xl:h-32 filter transition group-hover:grayscale duration-300 ease-in-out'
        whileInView={{opacity: 1, x:0}}
        src={props.Image}
        alt=''
        />
        <div className='absolute opacity-0 group-hover:opacity-80 border rounded-full transition duration-300
        ease-in-out group-hover:bg-white w-10 h-10 lg:h-24 lg:w-24 md:w-20 md:h-20 xl:w-32 xl:h-32'>
